...
StageInterface.prototype.initStage = function(obj){
	...
	fixDef.shape = new box2d.b2PolygonShape();
	var point = [
	             new box2d.b2Vec2(0, 50 / SCALE),
	             new box2d.b2Vec2(60/ SCALE, 50 / SCALE),
	             new box2d.b2Vec2((canvasWidth/2 - 16) / SCALE, (canvasHeight - 50) / SCALE),
	             new box2d.b2Vec2((canvasWidth/2 - 16) / SCALE, (canvasHeight) / SCALE),
	             new box2d.b2Vec2(0, (canvasHeight) / SCALE)
	           ];
	...
	point = [
	             new box2d.b2Vec2((canvasWidth-50) / SCALE, 50 / SCALE),
	             new box2d.b2Vec2(canvasWidth / SCALE, 50 / SCALE),
	             new box2d.b2Vec2(canvasWidth / SCALE, (canvasHeight) / SCALE),
	             new box2d.b2Vec2((canvasWidth/2 + 16) / SCALE, (canvasHeight) / SCALE),
	             new box2d.b2Vec2((canvasWidth/2 + 16) / SCALE, (canvasHeight-50) / SCALE)
	           ];
	fixDef.shape.SetAsArray(point, point.length);
	...
	holeBodyDef.position.x = (canvasWidth/2) / SCALE;
...
//    stage.addChildAt(grass, 0);
	...
	background.graphics.beginBitmapFill(loader.getResult("background1")).drawRect(0, 0, 1000, 645);
